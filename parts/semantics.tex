...
\todo{das folgende ergibt keinen sinn, weil es einfach nicht richtig ist. Gibt es unterschiedliche parents für werte und für scopes? was machen dann imports?}

Scope access happens via the dot-Operator ('.').
Scopes form a tree.
The root is called \texttt{\_root\_}.

Lookup is done starting from the current scope ascending to the parent and stops at root.
The parent of a value is its type.
